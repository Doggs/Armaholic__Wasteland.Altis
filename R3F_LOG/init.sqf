...
#include "R3F_LOG_ENABLE.h"
	...
	R3F_LOG_CFG_can_be_locked_by_player = [];
	...
	} forEach (R3F_LOG_CFG_can_be_moved_by_player + R3F_LOG_CFG_can_be_lifted + R3F_LOG_CFG_can_be_towed + R3F_LOG_classes_objets_transportables + R3F_LOG_CFG_can_be_locked_by_player);
	...
	if !(isDedicated) then
	{
		...
		R3F_LOG_FNCT_object_lsm = compile preprocessFile "R3F_LOG\objet_deplacable\objectLockStateMachine.sqf";
		...
		R3F_LOG_action_lock_object_valid = false;
		Object_isLocked = false;
